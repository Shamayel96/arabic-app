...
class DishesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dish" do
    assert_difference('Dish.count') do
      post dishes_url, params: { dish: { Dish: @dish.Dish, Ingredients: @dish.Ingredients, Recipe: @dish.Recipe } }
    end
  ...
  test "should update dish" do
    patch dish_url(@dish), params: { dish: { Dish: @dish.Dish, Ingredients: @dish.Ingredients, Recipe: @dish.Recipe } }
